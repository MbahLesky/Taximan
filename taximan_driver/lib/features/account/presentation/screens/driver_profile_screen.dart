            ...
            AppCard(
              child: Column(
                children: [
                  ...
                  const _ProfileLine(icon: Icons.phone_outlined, label: 'Phone', value: DummyData.driverPhone),
                  const _ProfileLine(icon: Icons.email_outlined, label: 'Email', value: DummyData.driverEmail),
                  AppButton(label: 'Edit profile placeholder', variant: AppButtonVariant.secondary, onPressed: () {}),
                  const SizedBox(height: AppSpacing.compact),
                  AppButton(label: 'Vehicle information', variant: AppButtonVariant.secondary, onPressed: () => context.go('/vehicle-information')),
                ],
              ),
            ),
          ],
